...
mixin _$HomeResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String mensage) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<T> data)? success,
    TResult? Function(String mensage)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Success<T> implements Success<T> {
  const _$Success(final List<T> data) : _data = data;
...
abstract class Success<T> implements HomeResult<T> {
  const factory Success(final List<T> data) = _$Success<T>;
...
abstract class _$$FailureCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String mensage});
}

/// @nodoc
class __$$FailureCopyWithImpl<T, $Res>
    extends _$HomeResultCopyWithImpl<T, $Res, _$Failure<T>>
  ...
  $Res call({
    ...
    return _then(_$Failure<T>(
      null == mensage
          ? _value.mensage
          : mensage // ignore: cast_nullable_to_non_nullable
              as String,
    ));
  }
}
...
class _$Failure<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'HomeResult<$T>.failure(mensage: $mensage)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.mensage, mensage) || other.mensage == mensage));
  }

  @override
  int get hashCode => Object.hash(runtimeType, mensage);
...
abstract class Failure<T> implements HomeResult<T> {
  const factory Failure(final String mensage) = _$Failure<T>;
